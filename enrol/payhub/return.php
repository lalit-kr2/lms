...
$PAGE->set_url('/enrol/payhub/return.php');
$PAGE->set_heading($SITE->fullname);
$PAGE->set_title(get_string('title:returnpage', 'enrol_payhub'));

// Get renderer.
$renderer = $PAGE->get_renderer('enrol_payhub');
$transactionrecord = $DB->get_record('enrol_payhub', array('id' => $eid));

$paynltransaction = new \enrol_payhub\transaction($transactionrecord);
